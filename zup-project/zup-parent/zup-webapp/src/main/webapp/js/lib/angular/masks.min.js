/**
 * angular-mask Personalized input masks for AngularJS
 * 
 * @version v1.2.3
...
/**
 * br-validations A library of validations applicable to several Brazilian data
 * like I.E., CNPJ, CPF and others
 * 
 * @version v0.2.1
...
/**
 * options { pesos: Array of values used to operate in sum step dvPos: Position
 * of the DV to validate considering the handledStr algorithmSteps: The four
 * DV's validation algorithm steps names }
 */
...
(function() {
			...
			link: function (scope, element, attrs, ctrl) {
				...
				function parse(value) {
					...
					if(angular.isDefined(attrs.uiNegativeNumber)){
						...
						// only apply the minus sign if it is negative
						// or(exclusive) needs to be negative
	...
	.directive('uiBrPhoneNumber',function() {
		/**
		 * FIXME: all numbers will have 9 digits after 2016. see
